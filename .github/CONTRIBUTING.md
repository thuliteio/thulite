...
* Please **do not** use the issue tracker for personal support requests (use the
  [Hugo Support Forums](https://discourse.gohugo.io/) to ask the Hugo Community for help).
...
case to convince the Hyas developers of the merits of this feature. Please
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   [rebase](https://docs.github.com/en/github/using-git/about-git-rebase)
